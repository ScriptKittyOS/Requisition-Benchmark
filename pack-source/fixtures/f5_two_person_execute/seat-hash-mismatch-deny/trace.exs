# Phase 2 fixture (REQ-093, fix review 2026-09-16): the two seats pin different payload hashes; the Execute carries the Approve's -> implicit deny (fix review 11).
[
  %{
  ...
  %{
    fields: %{payload_hash: "H2", idempotency_key: "K1", approval_id: "A1", scope: "S1"},
    resource: "Req::Approval::\"A1\"",
    kind: :response,
    action: "Coapprove",
