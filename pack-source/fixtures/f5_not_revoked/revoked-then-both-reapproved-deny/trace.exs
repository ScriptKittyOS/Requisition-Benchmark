# Phase 2 fixture (REQ-093, fix review 2026-09-16): Approve, Coapprove, Revoke, BOTH seats fresh: still terminal -> deny (our plane: :already_decided; the since-idiom and the per-seat conjunct both allowed this).
[
  %{
